        ...
        <div>
            ...
            <div className=" sticky top-0 z-50 bg-white dark:bg-gray-900  pt-4 px-4 -mx-4  mb-4">
                ...
                >
                    ...
                    <div
                        className="absolute border-l-2 border-violet-500 border-dashed h-full bg-background-elevated left-[calc(50%-1px)] "></div>
                </div>
            ...
            <span className="relative">
              ...
              >
                {allowTieBreaker ? (
                    ...
                    <div
                        className="w-full h-full text-white bg-gray-200 dark:bg-gray-700 dark:text-gray-950 flex justify-center items-center"></div>
                )}
              </div>
            </span>
                ...
                <div
                    className="flex sm:order-2 order-3 rounded-lg overflow-y-hidden overflow-x-auto whitespace-nowrap sm:w-auto w-full">
